...
export const Testimonial = () => {
    return (
        <section className="pb-[100px] ">
            <div className="text-3xl dark:text-gray-200 underline underline-offset-8 text-center my-5">Students About U-Kart</div>
            <div className="max-w-screen-xl mx-auto grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
